    ...
    <div class="col-md">
      ...
      <div class="board-mypage-list">
        ...
        <ul class="nav nav-tabs">
          <li class="nav-item">
            <a class="nav-link" @click="showTab('myPosts')" :class="{ active: activeTab === 'myPosts' }">작성한 게시물</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" @click="showTab('likedPosts')" :class="{ active: activeTab === 'likedPosts' }">좋아요 누른
              게시물</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" @click="showTab('myReplies')" :class="{ active: activeTab === 'myReplies' }">작성한
              댓글</a>
          </li>
        </ul>
      </div>
