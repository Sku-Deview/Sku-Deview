...
public class QMemberSkill extends EntityPathBase<MemberSkill> {
    ...
    private static final long serialVersionUID = -1152111012L;
    ...
    public final kr.co.skudeview.domain.skill.entity.QSkill skill;
    ...
    public QMemberSkill(Class<? extends MemberSkill> type, PathMetadata metadata, PathInits inits) {
        ...
        this.skill = inits.isInitialized("skill") ? new kr.co.skudeview.domain.skill.entity.QSkill(forProperty("skill")) : null;
    }
