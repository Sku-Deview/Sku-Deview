package kr.co.skudeview.domain.report.controller;
...
public class ReportApiController {
    ...
    public ResponseFormat<List<ReportResponseDto.READ>> getAllReportsByPost(@PathVariable Long postId) {
        return ResponseFormat.successWithData(kr.co.skudeview.global.model.ResponseStatus.SUCCESS_OK, reportService.getAllReportsByPost(postId));
    }
    ...
    public ResponseFormat<ReportResponseDto.READ> getReportDetail(@PathVariable Long postId, @PathVariable Long reportId) {
        return ResponseFormat.successWithData(kr.co.skudeview.global.model.ResponseStatus.SUCCESS_OK, reportService.getReportDetail(reportId));
    }
    ...
    public ResponseFormat<List<ReportResponseDto.READ>> getAllReports() {
        return ResponseFormat.successWithData(kr.co.skudeview.global.model.ResponseStatus.SUCCESS_OK, reportService.getAllReports());
    }
